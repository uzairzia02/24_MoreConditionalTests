...
console.log("Test for inequality : Uzair as string != Umair : ", "Uzair" as string != "Umair");
...
console.log("Numerical tests for inequality : 45 !== 45: ", (45 as number)  != 55);
...
console.log("Testing for or Operator: 2 is equal to 4 or 5 is less than 10: ", (2 as number)===4 || 5<10);
